    ...
    >
      <div className="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
        <Link
          href={{
            pathname: "/products/1",
            query: "photo-1646753522408-077ef9839300",
          }}
        >
          <img
      ...
      <div className="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
        <Link
          href={{
            pathname: "/products/2",
            query: "photo-1651950519238-15835722f8bb",
          }}
        >
          <img
      ...
      <div className="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
        <Link
          href={{
            pathname: "/products/3",
            query: "photo-1651950537598-373e4358d320",
          }}
        >
          <img
      ...
      <div className="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
        <Link
          href={{
            pathname: "/products/4",
            query: "photo-1651950540805-b7c71869e689",
          }}
        >
          <img
      ...
      <div className="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
        <Link
          href={{
            pathname: "/products/5",
            query: "photo-1649261191624-ca9f79ca3fc6",
          }}
        >
          <img
      ...
      <div className="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
        <Link
          href={{
            pathname: "/products/6",
            query: "photo-1649261191606-cb2496e97eee",
          }}
        >
          <img
